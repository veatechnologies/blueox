(function ($) {
    ...
    jQuery(document).ready(function ($) {
        jQuery(document).find('.vi_wcaio_mini_cart_sidebar_icon').hide();
        jQuery(document).find('.vi_wcaio_mini_cart_sidebar_icon_count').text(0);
        jQuery(document).find('.vi_wcaio_mini_cart_content').remove();
        jQuery(document).find('.vi_wcaion_mini_cart_sidebar').remove();
         ...
         */
        jQuery(document).on('click', '.vi_wcaio_mini_cart_sidebar_icon', function (e) {
            e.preventDefault();
            setTimeout(function () {
                jQuery(document).find('.vi_wcaio_mini_cart_sidebar_icon').show();
            }, 500);
...
//                alert(res.Message);
            ...
            if (cartQty > 0) {
                jQuery(document).find('.vi_wcaio_mini_cart_sidebar_icon_count').text(cartQty);
                jQuery(document).find('.vi_wcaio_mini_cart_sidebar_icon').show();
            }else{
                jQuery(document).find('.vi_wcaio_mini_cart_sidebar_icon').hide();
            }
