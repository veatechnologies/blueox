...
function wp_bootstrap_4_scripts() {
	...
	wp_enqueue_style( 'tiny-slider-style', esc_url('https://cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.9.2/tiny-slider.css'), array(), false );
	wp_enqueue_style( 'blueox-style', get_stylesheet_uri(), array(), false );

	wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/assets/css/custom.css', array(), false );
	...
	wp_enqueue_script( 'tiny-slider', esc_url('https://cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.9.2/min/tiny-slider.js'), array('jquery'), '2.9.2', true );
