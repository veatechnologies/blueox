						...
						<div class="cart-product-info">
							...
							<div class="cart-update-remove">
								...
								<div class="product-update">
									<button type="submit" class="cart-update-btn" name="update_cart" value="<?php esc_attr_e( 'Update', 'woocommerce' ); ?>"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button>
								</div>
