...
$web_domain=str_replace("www.","",$_SERVER['HTTP_HOST']);
		...
		define('SSF_WP_MANAGE_CATEGORY_PAGE', SSF_WP_TOP_NAV_BASE.SSF_WP_PAGES_DIR."/category.php");
		define('SSF_WP_ADD_CATEGORY_PAGE', SSF_WP_MANAGE_CATEGORY_PAGE."&pg=add-category");
		define('SSF_WP_MANAGE_SUBCAT_PAGE', SSF_WP_TOP_NAV_BASE.SSF_WP_PAGES_DIR."/subcategory.php");
		define('SSF_WP_ADD_SUBCAT_PAGE', SSF_WP_MANAGE_SUBCAT_PAGE."&pg=add-subcategory");
		...
		define('SSF_WP_DISTANCE_PAGE', SSF_WP_TOP_NAV_BASE.SSF_WP_DIR."/distancesetup.php");
