        ...
        function onLoad() {
            ...
            function continueInit() {
                ...
                jQuery(xml.data).find('label').each(function() {
					...
					var distance = jQuery(this).find('distance').text().trim();
                    legend[tag] = copy;
                    ...
                    radiosStrArray.push([
                        ...
                        '<label class="label--vertical-align ssflabel">',
                            ...
                            '<div class="label__contents">',
                                ...
                                '<input data-distance="',distance,'" class="storesProductsServices" type="radio" name="storesProductsServices"  value="', tag, '" /> ', copy,
    ...
    function startMap() {
	   ...
	   var defaultLatLng
        ...
        function setupEventHandlers() {
			...
			jQuery(document).on( "change", "input[name='storesProductsServices']", function () {
				var radius = jQuery(this).data('distance');
				if(radius!=''){
					ssf_distance_limit= parseInt(radius);
				}
			 });
