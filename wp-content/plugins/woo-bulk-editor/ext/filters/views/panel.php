...
<div style="clear: both;"></div>
<br />
<a href="https://bulk-editor.com/document/filters/" target="_blank" class="button button-primary"><span class="icon-book"></span>&nbsp;<?php _e('Documentation', 'woo-bulk-editor') ?></a>
<br />
